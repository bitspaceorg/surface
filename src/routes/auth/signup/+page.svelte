...
<div class="{$darkMode ? 'bg-dark' : 'bg'} w-full h-full flex flex-col items-center justify-center">
    <form on:submit|preventDefault class="p-12 flex flex-col items-center justify-center dark:bg-darkblack bg-white dark:text-white shadow-2xl border-2 dark:border-white border-black">
        <div>
            ...
            <div class="w-[350px] h-[80px] my-4 flex flex-col items-start justify-center">
                ...
                <input bind:value={USERNAME} id="username" class="w-full h-[50px] outline-none text-xl dark:border-white dark:bg-black font-black py-2 px-4 border-black border-2" placeholder="xxxxx">
            </div>
            <div class="w-[350px] h-[80px] flex flex-col items-start justify-center">
                ...
                <input bind:value={PASSWORD} id="password" type="password" class="w-full h-[50px] outline-none text-xl dark:border-white dark:bg-black font-black py-2 px-4 border-black border-2" placeholder="* * * * *">
            </div>
            <div class="w-[350px] h-[80px] my-4 flex flex-col items-start justify-center">
                <label for="confirm_password" class="text-xl font-black">CONFIRM PASSWORD</label>
                <input bind:value={CONFIRM_PASSWORD} id="confirm_password" type="password" class="w-full h-[50px] outline-none text-xl dark:border-white dark:bg-black font-black py-2 px-4 border-black border-2" placeholder="* * * * *">
            </div>
            <div class="w-[350px] h-[80px] my-4 flex flex-col items-start justify-center">
                <label for="image_url" class="text-xl font-black">PROFILE IMAGE URL</label>
                <input bind:value={IMAGE_URL} id="image_url" class="w-full h-[50px] outline-none text-xl dark:border-white dark:bg-black font-black py-2 px-4 border-black border-2" placeholder="https://avatars.githubusercontent.com/u/128706614?v=4">
            </div>
        </div>
    ...
    <a href="/auth/login" class="mt-10 text-xl w-[450px] text-end px-2 dark:text-white">LOGIN?</a>
</div>
